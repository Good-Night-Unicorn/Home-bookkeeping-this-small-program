		...
		<view class="container">
			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					...
					<!-- 名字-->
					<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>
						{{detail.xiaofeixiangqingName}}
					</view>
				</view>
				...
				<view class="detail-list-item"
					...
					<view class="lable"
						...
						消费金额：</view>
					<view class="text" :style='{"color":"#4477C5","textAlign":"center","fontSize":"24rpx"}'>
						{{detail.xiaofeixiangqingMoney}}
					</view>
				</view>
				<view class="detail-list-item"
					:style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
			...
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.xiaofeixiangqingContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('xiaofeixiangqing', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.xiaofeixiangqingPhoto ? this.detail.xiaofeixiangqingPhoto.split(",") :
			[];
			},
