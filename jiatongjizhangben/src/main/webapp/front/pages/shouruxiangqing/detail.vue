		...
		<view class="container">
			...
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.shouruxiangqingContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('shouruxiangqing', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.shouruxiangqingPhoto ? this.detail.shouruxiangqingPhoto.split(",") : [];
			},
